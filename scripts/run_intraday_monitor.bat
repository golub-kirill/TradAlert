...
REM Runs scripts\live\intraday_monitor.py with the project virtualenv and appends the
...
".venv\Scripts\python.exe" scripts\live\intraday_monitor.py %*>> "logs\intraday_monitor.log" 2>&1
set "RC=%ERRORLEVEL%"
